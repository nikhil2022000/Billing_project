			...
			<nav class="sidebar-wrapper">
				...
				<div class="sidebar-tabs">
					...
					<div class="nav" role="tablist" aria-orientation="vertical">
						<a href="#" class="logo">
							<img src="{{'design/img/logo.svg'}}" alt="Uni Pro Admin">
						</a>
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul class="tile-menu">
										...
										<li>
											<a href="/bill_categories"><i class="icon-bar-chart"></i> Categories</a>
										</li>
										<li>
											<a href="/Opratores_set"><i class="icon-shopping-bag1"></i> Opratores</a>
										</li>
										<li>
											<a href="/payment_units"><i class="icon-layers2"></i> payment units</a>
										</li>
										<li>
											<a href="relation_set"><i class="icon-triangle"></i> Relationship</a>
										</li>
										<li>
											<a href="emp"><i class="icon-calendar1"></i>EMP/users</a>
										</li>
										<li>
										...
										<li>
											<a href="mini_master"><i class="icon-server"></i>Add Number</a>
										</li>
									</ul>
									<ul class="tile-menu">
										...
										<div class="customScroll">
											<ul class="header-notifications">
												<li>
													<a href="#">
														<div class="user-img online">
															<img src="{{'design/img/user6.png'}}" alt="User">
														</div>
														<div class="details">
												...
												<li>
													<a href="#">
														<div class="user-img busy">
															<img src="{{'design/img/user10.png'}}" alt="User">
														</div>
														<div class="details">
												...
												<li>
													<a href="#">
														<div class="user-img away">
															<img src="{{'design/img/user21.png'}}" alt="User">
														</div>
														<div class="details">
												...
												<li>
													<a href="#">
														<div class="user-img busy">
															<img src="{{'design/img/user15.png'}}" alt="User">
														</div>
														<div class="details">
												...
												<li>
													<a href="#">
														<div class="user-img online">
															<img src="{{'design/img/user5.png'}}" alt="User">
														</div>
														<div class="details">
